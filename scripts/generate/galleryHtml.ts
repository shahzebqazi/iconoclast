...
/**
 * Single-page gallery for GitHub Pages (`docs/` as site root).
 */
export function buildGalleryHtml(entries: AssetEntry[], siteTitle: string): string {
  ...
  const sections = [...byCategory.entries()]
    .map(([category, items]) => {
      const cards = items
        .map((a) => {
          const href = `assets/generated/${a.relativePath}`;
...
<head>
  ...
  <link rel="stylesheet" href="assets/generated/theme.css" />
